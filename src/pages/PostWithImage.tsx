...
function PostWithImage({ route, navigation }: { route: any; navigation: any }) {
  const { owner, post, time, _id, name, last_Name, biography, url } = route.params;
        ...
        <Text
          ...
          <FlatList
            ...
            renderItem={({ item }) => {
             ...
             >
             <View style={{  width: width * 0.9, display: "flex", 
